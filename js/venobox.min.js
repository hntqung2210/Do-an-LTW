                ...
                this.each(function () {
                              ...
                              void r.animate({ opacity: 0 }, 500, function () {
                                  k.css("background", g),
                                      ...
                                      "iframe" == e.data("vbtype")
                                          ...
                                          : "ajax" == e.data("vbtype")
                                          ? G()
                                          : "video" == e.data("vbtype") || "vimeo" == e.data("vbtype") || "youtube" == e.data("vbtype")
                                          ? K(o)
                                          : (r.html('<img src="' + d + '">'), te()),
                                      (O = e),
                                      q(),
                    ...
                    function F(e) {
                        if (D === !0) {
                            ...
                            var o = O,
                                t = !1;
                            (Y = X - z), 0 > Y && _ === !0 && ((o = w), (t = !0)), Y > 0 && P === !0 && ((o = C), (t = !0)), Math.abs(Y) >= $ && t === !0 ? A(o) : r.css({ "margin-left": 0, "margin-right": 0 });
                        }
                    }
                    function G() {
                    ...
                    function ae() {
                        i.html(x),
                            r.find(">:first-child").addClass("figlio").css({ width: v, height: u, padding: s, background: t }),
                    ...
                    (I.VBclose = function () {
                        ...
                        O.on("click", function (b) {
                            ...
                            return (
                                ...
                                i.css({ color: H.titleColor, "background-color": H.titleBackground }),
                                ...
                                k.animate({ opacity: 1 }, 250, function () {
                                    "iframe" == O.data("vbtype")
                                        ...
                                        : "ajax" == O.data("vbtype")
                                        ? G()
                                        : "video" == O.data("vbtype") || "vimeo" == O.data("vbtype") || "youtube" == O.data("vbtype")
                                        ? K(o)
                                        : (r.html('<img src="' + d + '">'), te()),
                    ...
                    "ontouchstart" in window
                        ? (e(document).on("touchstart", re), e(document).on("touchmove", re), e(document).on("touchend", re))
                        : (e(document).on("mousedown", ce), e(document).on("mouseup", ce), e(document).on("mouseout", ce), e(document).on("mousemove", ce)),
